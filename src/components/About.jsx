            ...
            <div className="hero min-h-screen">
                <div className="hero-content flex-col md:flex-row">
                    ...
                    <div className='md:w-[50%] '>
                        ...
                        <p className="py-6 text-xl">Welcome to Vibrant Vibes, your premier partner in creating unforgettable music experiences. With a passion for music and a dedication to excellence, we've been arranging Concerts and Music Festivals that rock the world since 2016.
                        <br />
