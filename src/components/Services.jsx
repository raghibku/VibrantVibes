...
const Services = () => {
    ...
    return (
        <div name="services" className='flex flex-col items-center justify-center my-16 '>
            <h1 className='text-3xl font-bold text-center my-8 text-primary'>Our Services</h1>
            <div className=''>
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-4 w-full'>
                    {
                        services ? services.map((service) => { return(
                            <div data-aos="fade-up" key={service.id} className='flex justify-center items-center px-12 py-12 w-[430px] h-[480px] bg-base-200 rounded-lg'>
